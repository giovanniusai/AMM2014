...
class Settings {
    ...
    public static $db_user = 'usaiGiovanni';
    public static $db_password = 'sarago486';
    public static $db_name='amm14_usaiGiovanni';
        ...
        if (!isset(self::$appPath)) {
            ...
            switch ($_SERVER['HTTP_HOST']) {
                case 'localhost':
                    ...
                    self::$appPath = 'http://' . $_SERVER['HTTP_HOST'] . '/ProgettoEsame/MioProgetto/';
                    break;
                case 'spano.sc.unica.it':
                    // configurazione pubblica
                    self::$appPath = 'http://' . $_SERVER['HTTP_HOST'] . '/amm2014/usaiGiovanni/ProgettoEsame/MioProgetto/';
                    break;

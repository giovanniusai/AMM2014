       ...
       <?foreach ($ordini as $ordine) {
           $cliente = UserFactory::instance()->getClientePerId($ordine->getCliente());
            ...
            <tr>
                ...
                <td class="col-small"><a href="dipendente/ordini?cmd=paga&ordine=<?= $ordine->getId() ?>" title="paga">
                <img src="../images/paga.png" alt="paga"></a></td> 
                <td class="col-small"><a href="dipendente/ordini?cmd=dettaglio&ordine=<?= $ordine->getId() ?>" title="dettaglio_ordine">

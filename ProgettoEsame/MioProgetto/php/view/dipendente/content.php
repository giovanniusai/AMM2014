    ...
    <?php default: ?>
        ...
        <table class="content">
            <tr>               
                ...
                <td class="noRighe"><a href="dipendente/anagrafica" title="anagrafica">
                    <img src="../images/anagrafica.png" alt="anagrafica"></a></td>                    
                                             
                <td class="noRighe"><a href="dipendente/gestione_ordini" title="gestione_ordini">
            ...
            <tr>
               ...
               <td class="noRighe"><a href="dipendente/ricerca_ordini" title="ricerca_ordini">
